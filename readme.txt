IMPORTANT: Don't forget to fill in the database connection information on lines 19-23, follow template
...
-User can add a new person to bsg_people by clicking 'Display all forms', filling out the 'Add Person' form, and clicking the 'Add Person' button
